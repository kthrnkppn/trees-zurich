...
// alphabetischen Sortierung nach deutschem Namen.
export const curiosities = [
  ...
  { genus: 'Gymnocladus', label: { de: 'Geweihbaum', en: 'Kentucky coffeetree' }, emoji: '🦌' },
  { genus: 'Ginkgo', label: { de: 'Ginkgo', en: 'Ginkgo' }, emoji: '🪭' },
  { genus: 'Eucommia', label: { de: 'Guttaperchabaum', en: 'Hardy rubber tree' }, emoji: '🎈' },
  { genus: 'Asimina', label: { de: 'Indianerbanane', en: 'Pawpaw' }, emoji: '🍌' },
  ...
  { genus: 'Albizia', label: { de: 'Seidenbaum', en: 'Silk tree' }, emoji: '😴' },
  { genus: 'Zanthoxylum', art: 'piperitum', label: { de: 'Sichuanpfeffer', en: 'Sichuan pepper' }, emoji: '🌶️' },
  { genus: 'Davidia', label: { de: 'Taschentuchbaum', en: 'Dove tree' }, emoji: '🤍' },
