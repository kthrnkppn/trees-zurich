...
- **Öffentliche Brunnen (Wasserstellen)**: dunkelblaue Tropfen-Pins, erscheinen
  ...
  Klick-Popup zeigt Name + die rohe Wasserart (Quellwasser/Züriwasser). **Keine**
  Trinkwasser-Wertung: Der Datensatz hat kein verlässliches Kennzeichen, in
  Zürich sind fast alle Brunnen trinkbar, und „Kein Trinkwasser" steht nur als
  Schild vor Ort. Datenherkunft/Filter s. §9.
