...
const strings = {
  de: {
    ...
    'filter.rainInfo': 'Regen der letzten 30 Tage: {mm} Liter/m² – üblich für einen Sommermonat sind rund 115 (MeteoSchweiz, Mittel aus Fluntern, Affoltern, Kloten & Waldegg).',
    ...
    'filter.matchCount': '{n} Treffer auf der Karte',
  ...
  en: {
    ...
    'filter.rainInfo': 'Rain over the last 30 days: {mm} litres/m² – a normal summer month sees about 115 (MeteoSwiss, mean of Fluntern, Affoltern, Kloten & Waldegg).',
    'filter.apply': 'Filter',
    'filter.reset': 'Reset',
    ...
    'filter.matchCount': '{n} shown on the map',
