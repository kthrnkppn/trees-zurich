...
const strings = {
  de: {
    ...
    'filter.youngTree': 'Durstige Jungbäume',
    'filter.youngTreeTitle': 'Frisch gepflanzte Bäume (bis zum 5. Standjahr) haben noch flache Wurzeln und freuen sich in Hitze- und Trockenphasen über Wasser – besonders, wenn sie die Blätter hängen lassen oder braune Ränder zeigen.',
    'filter.youngTreeHint': 'Richtwert (Grün Stadt Zürich): ~50–70 Liter je Gabe, bei Trockenheit bis zu 3× pro Woche. Wichtig: langsam giessen, damit das Wasser tief einsickert statt oberflächlich abzulaufen. Hängt ein Bewässerungssack am Stamm, einfach diesen füllen. Blaue Tropfen zeigen Brunnen zum Wasserholen.',
    'filter.rainInfo': 'Regen der letzten 30 Tage: {mm} Liter/m² – üblich für einen Sommermonat sind rund 120 (MeteoSchweiz, Zürich/Fluntern).',
    ...
    'fountains.drinking': 'Trinkwasser (Züriwasser)',
    'fountains.nonDrinking': 'Kein Trinkwasser – zum Giessen geeignet',
    'fountains.fallbackName': 'Brunnen',
    ...
    'stats.factPlantingAge': 'Das Pflanzjahr ist nicht das Alter des Baums: Strassenbäume kommen meist schon als mehrjährige Baumschul-Hochstämme in den Boden – ein frisch gepflanzter Baum kann darum deutlich älter wirken. Rund {n} Bäume wurden in den letzten fünf Jahren gepflanzt.',
  },
  en: {
    ...
    'filter.youngTree': 'Thirsty young trees',
    'filter.youngTreeTitle': 'Newly planted trees (through their 5th year) still have shallow roots and welcome water in hot, dry spells – especially when their leaves start drooping or turning brown at the edges.',
    'filter.youngTreeHint': 'Guideline (City of Zurich): ~50–70 litres per watering, up to 3× a week in dry spells. Key: water slowly so it soaks deep instead of running off the surface. If a watering bag is fastened around the trunk, just fill that. Blue drops show fountains to fetch water from.',
    'filter.rainInfo': 'Rain over the last 30 days: {mm} litres/m² – a normal summer month sees about 120 (MeteoSwiss, Zürich/Fluntern).',
    'filter.apply': 'Filter',
    'filter.reset': 'Reset',
    ...
    'fountains.drinking': 'Drinking water (tap network)',
    'fountains.nonDrinking': 'Not drinking water – fine for watering',
    'fountains.fallbackName': 'Fountain',
    ...
    'stats.factPlantingAge': "A tree's planting year isn't its age: street trees usually go into the ground as nursery stock that's already several years old – so a freshly planted tree can look much more established. About {n} trees were planted in the last five years.",
  },
};
