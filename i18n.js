...
const strings = {
  de: {
    ...
    'filter.youngTreeHint': 'Richtwert (Grün Stadt Zürich): ~50–70 Liter je Gabe, bei Trockenheit bis zu 3× pro Woche. Wichtig: langsam giessen, damit das Wasser tief einsickert statt oberflächlich abzulaufen. Blaue Tropfen zeigen Brunnen zum Wasserholen.',
  ...
  en: {
    ...
    'filter.youngTreeHint': 'Guideline (City of Zurich): ~50–70 litres per watering, up to 3× a week in dry spells. Key: water slowly so it soaks deep instead of running off the surface. Blue drops show fountains to fetch water from.',
