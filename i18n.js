...
const strings = {
  de: {
    ...
    'fountains.label': 'Brunnen ({n})',
    'fountains.title': 'Öffentliche Brunnen als Wasserstellen zum Giessen einblenden.',
  ...
  en: {
    ...
    'fountains.label': 'Fountains ({n})',
    'fountains.title': 'Show public fountains as water points for watering.',
